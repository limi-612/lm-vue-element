...
export const appRouter = [
  ...
  },
  {
    ...
    children: [
      ...
      { id: '2-5', show: true, path: 'palatability', name: 'palatability', meta: { title: 'menus.palatability', icon: 'el-icon-menu' }, component: () => import('@/views/study-file/palatability/palatability.vue') },
